...
const SignupForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Pass first_name and last_name as metadata to signUp
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={loading || googleLoading}
            className="mt-4 w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg font-semibold hover:bg-gray-50 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
          >
            {googleLoading ? (
              <>
                <Loader2 className="w-5 h-5 animate-spin" />
